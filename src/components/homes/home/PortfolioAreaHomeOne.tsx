...
import portfolio_img_5 from "@/assets/img/portfolio/portfolio-3.jpg";
  ...
  portfolio_data: [
    {
      id: 2,
      img: projects_img_2,
      bg_img: "/assets/img/projects/project-2.jpg",
      title: 'Space Needle',
    },
    {
      id: 3,
      img: projects_img_3,
      bg_img: "/assets/img/projects/project-3.png",
      title: "Crisis Cleanup",
    },
    {
      id: 4,
      img: projects_img_4,
      bg_img: "/assets/img/projects/project-4.png",
      title: 'Space Needle',
    },
...
const PortfolioAreaHomeOne = () => {
  ...
  return (
    <>
      <section id="portfolio" className="tp-portfolio-area tp-btn-trigger-2 p-relative z-index-1 pt-280 pb-40 fix">
                    ...
                    <Link href="/portfolio-details">
                      <div className="tp-portfolio-thumb img-1 w-img fix ">
                        ...
                        <div className="tp-portfolio-thumb-img ">
                          <Image data-speed="0.85" style={{ objectFit: 'cover', height: "auto" }} src={projects_img_1} alt="image-here" />
                        </div>
                      </div>
